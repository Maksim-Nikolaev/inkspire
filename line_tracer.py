...
# ── Fast X11 mouse control via ctypes ──
...
def detect_edges(gray_img, mode, threshold, canny_lo, canny_hi,
    ...
    if mode == "Canny Edge":
        ...
        edges = _auto_detect(img, threshold, canny_lo, canny_hi,
...
def _auto_detect(img, threshold, canny_lo, canny_hi, adaptive_block, adaptive_c):
    """
